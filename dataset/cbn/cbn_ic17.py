...
ic17_root_dir = './data/MLT2017/'
ic17_train_data_dir = ic17_root_dir + 'train_data/images/'
ic17_train_gt_dir = ic17_root_dir +'train_data/gts/'
ic17_test_data_dir = ic17_root_dir + 'val_data/images/'
ic17_test_gt_dir = ic17_root_dir + 'val_data/gts/'

#ic17_test_data_dir = ic17_root_dir + 'test_data/images/'
#ic17_test_gt_dir = ic17_root_dir + 'test_data/gts/'
...
#def resize_range(image, size=(960, 1920)):
def resize_range(image, size=(1024, 2048)):
    h, w, _ = image.shape
...
class CBN_IC17(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            data_dirs = [ic17_train_data_dir]
            gt_dirs = [ic17_train_gt_dir]
        elif split == 'test':
            data_dirs = [ic17_test_data_dir]
            gt_dirs = [ic17_test_gt_dir]
        else:
