...
ic19_root_dir = './data/MLT2019/'
ic19_train_data_dir = ic19_root_dir + 'ImagesPart/'
ic19_train_gt_dir = ic19_root_dir + 'train_gt/'
ic19_test_data_dir = ic19_root_dir + 'valData/gt/images/'
ic19_test_gt_dir = ic19_root_dir + 'valData/gt/gts/'

#ic19_test_data_dir = ic19_root_dir + 'TestImagesPart/'
#ic19_test_gt_dir = ic19_root_dir + ''
...
class CBN_IC19(data.Dataset):
    def __init__(self,
        ...
        if split == 'train':
            ...
            data_dirs = [ic19_test_data_dir]
            gt_dirs = [ic19_test_gt_dir]
        else:
